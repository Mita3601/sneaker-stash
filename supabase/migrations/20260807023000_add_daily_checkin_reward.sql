...
begin
  ...
  eligible_at := me.created_at + interval '24 hours';
  if me.last_checkin_at is not null then
    eligible_at := greatest(eligible_at, me.last_checkin_at + interval '24 hours');
  end if;
